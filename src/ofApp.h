...
class ofApp : public ofBaseApp{
	...
	public:
        ...
        ofImage parrotImg; // bin/data 디렉토리에 저장한 앵무새 텍스쳐 파일을 로드 및 프래그먼트 셰이더의 유니폼 변수로 전송하기 위해 헤드파일에 ofImage 객체 변수를 선언함.
        ofImage checkerImg; // bin/data 디렉토리에 저장한 체크무늬 텍스쳐 파일을 로드 및 프래그먼트 셰이더의 유니폼 변수로 전송하기 위해 헤드파일에 ofImage 객체 변수를 선언함.
